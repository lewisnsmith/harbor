"""Tests for harbor.risk — covariance, HRP, Monte Carlo, regime detection, correlation."""
...
class TestShrinkageCovariance:
    def test_ledoit_wolf_shape(self, synthetic_multi_returns):
        from harbor.risk.covariance import shrinkage_covariance
...
class TestEstimateCovariance:
    def test_sample_dispatch(self, synthetic_multi_returns):
        from harbor.risk.covariance import estimate_covariance, sample_covariance
...
class TestCovToCorr:
    def test_diagonal_is_one(self, synthetic_multi_returns):
        from harbor.risk.covariance import sample_covariance
        from harbor.risk.hrp import cov_to_corr
        cov = sample_covariance(synthetic_multi_returns)
...
# ===================================================================
# harbor.risk.monte_carlo
# ===================================================================

class TestSimulateMultivariateReturns:
    def test_output_shape(self, synthetic_multi_returns):
        from harbor.risk.covariance import sample_covariance
        from harbor.risk.monte_carlo import simulate_multivariate_returns
...
class TestPortfolioVarCvar:
    ...
    def test_invalid_alpha_raises(self, equal_weights):
        from harbor.risk.monte_carlo import portfolio_var_cvar
...
class TestVolControlPressureProxy:
    def test_returns_named_series(self, synthetic_series_returns):
        from harbor.risk.regime_detection import vol_control_pressure_proxy
...
class TestCoerceMarketReturns:
    def test_empty_dataframe_raises(self):
        from harbor.risk.regime_detection import _coerce_market_returns
        with pytest.raises(ValueError, match="empty"):
...
# ===================================================================
# harbor.risk.correlation (stub — expected to raise)
# ===================================================================
...
class TestRiskPublicApi:
    def test_all_exports_importable(self):
        ...
        from harbor.risk import __all__
        for name in __all__:
