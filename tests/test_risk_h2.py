"""Tests for HARBOR H2 risk modules — regime covariance, non-Gaussian MC,
...
def cov_matrix(synthetic_returns) -> pd.DataFrame:
    from harbor.risk.covariance import sample_covariance
...
# ===================================================================
# harbor.risk.covariance — H2 regime-aware extensions
# ===================================================================

class TestRegimeAwareCovariance:
    def test_returns_dict_of_dataframes(self, synthetic_returns):
        from harbor.risk.covariance import regime_aware_covariance
        labels = pd.Series(
...
class TestExpandingRegimeCovariance:
    def test_returns_high_low_keys(self, synthetic_returns):
        from harbor.risk.covariance import expanding_regime_covariance
...
# ===================================================================
# harbor.risk.monte_carlo — H2 non-Gaussian extensions
# ===================================================================

class TestStudentTSimulation:
    def test_output_shape(self, mean_returns, cov_matrix):
        from harbor.risk.monte_carlo import simulate_student_t_returns
    ...
    def test_heavier_tails_than_normal(self, mean_returns, cov_matrix):
        from harbor.risk.monte_carlo import simulate_multivariate_returns, simulate_student_t_returns
...
class TestFactorSimulation:
    def test_output_shape(self):
        from harbor.risk.monte_carlo import simulate_factor_returns
...
class TestSimulateReturnsDispatch:
    def test_normal_dispatch(self, mean_returns, cov_matrix):
        from harbor.risk.monte_carlo import simulate_returns
...
class TestMonteCarloFromHistoryH2:
    def test_student_t_method(self, synthetic_returns, equal_weights):
        from harbor.risk.monte_carlo import monte_carlo_var_cvar_from_history
...
# ===================================================================
# harbor.risk.scenarios
# ===================================================================

class TestApplyVolSpike:
    def test_variances_scaled(self, cov_matrix):
        from harbor.risk.scenarios import apply_vol_spike
...
class TestApplyCorrelationSpike:
    def test_off_diag_set(self, cov_matrix):
        from harbor.risk.scenarios import apply_correlation_spike
...
class TestApplySectorCrash:
    def test_sector_shocked(self, mean_returns):
        from harbor.risk.scenarios import apply_sector_crash
...
class TestRunScenarioSuite:
    def test_runs_multiple_scenarios(self, equal_weights, mean_returns, cov_matrix):
        from harbor.risk.scenarios import run_scenario_suite
        config = [
...
# ===================================================================
# harbor.risk.decomposition
# ===================================================================

class TestMarginalContributionToRisk:
    def test_shape(self, equal_weights, cov_matrix):
        from harbor.risk.decomposition import marginal_contribution_to_risk
...
class TestComponentRisk:
    def test_sums_to_portfolio_vol(self, equal_weights, cov_matrix):
        from harbor.risk.decomposition import component_risk
...
class TestPercentRiskContribution:
    def test_sums_to_one(self, equal_weights, cov_matrix):
        from harbor.risk.decomposition import percent_risk_contribution
...
class TestFactorRiskDecomposition:
    def test_variance_adds_up(self):
        from harbor.risk.decomposition import factor_risk_decomposition
...
class TestClusterRiskAttribution:
    def test_output_columns(self, equal_weights, cov_matrix):
        from harbor.risk.decomposition import cluster_risk_attribution
...
class TestConcentrationMetrics:
    def test_equal_weights_effective_n(self, equal_weights, cov_matrix):
        from harbor.risk.decomposition import concentration_metrics
...
class TestRiskEngine:
    def test_default_config(self):
        from harbor.risk.engine import RiskConfig, RiskEngine
        engine = RiskEngine()
    ...
    def test_estimate_covariance(self, synthetic_returns):
        from harbor.risk.engine import RiskEngine
        engine = RiskEngine()
...
class TestRiskConfigLoaders:
    def test_load_risk_config(self):
        from harbor.risk.engine import load_risk_config
    ...
    def test_load_scenarios_config(self):
        from harbor.risk.engine import load_scenarios_config
...
class TestRiskH2PublicApi:
    def test_all_h2_exports_importable(self):
        ...
        for name in h2_names:
            assert hasattr(risk_mod, name), f"{name} not importable from harbor.risk"
