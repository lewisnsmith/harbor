"""
hangar.ml — Machine learning and deep learning extensions.
...
Sub-packages:
- hangar.ml.volatility: LSTM/GRU volatility forecasters.
- hangar.ml.behavior_agents: Deep RL behavioral portfolio agents.

Utilities:
- hangar.ml.checkpoints: File-based model checkpoint registry.
"""
