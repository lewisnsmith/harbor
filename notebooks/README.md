...
## HANGAR Paper Trading V1 (Active)

Current V1 paper trading strategy notebooks.

| Notebook | Description |
|---|---|
| `v1_HANGAR_Paper_Trading_Algorithm.ipynb` | Canonical V1 baseline — use for manual research runs and baseline behavior comparisons |
