...
A system I can trust with real capital — one that prioritizes transparency, validation, and graceful failure. I've also grown interested in the broader impact trading algorithms and AI/ML have on retail investors, and I continue to question fundamental assumptions: whether factor-based equity selection is the right approach at my scale, and whether the alpha I'm chasing even exists without institutional resources.

This project taught me to respect the gap between theory and practice, to be skeptical of my own metrics, and to value simplicity and reliability over sophistication.
